...
static const int thresh0 = 2000; // threshold for sensor 0
static const int thresh1 = 500; // threshold for sensor 1
static const int thresh_wall_f = 100; 
static const int thresh_wall_r = 100; 
static const int thresh_wall_l = 190; 
...
void orient(int xt, int yt, int x, int y) {
  ...
  if(xt > x){
    ...
    //need to go north
      ...
      else if(orientation == 3){turnRight();turnRight();}
      orientation = 1;
    }
    //need to go south
    else if(yt < y){
      if(orientation == 2){turnLeft();}
      else if(orientation == 1){turnRight();turnRight();}
...
//      transmit = transmit + pos/100 + "," + pos%100;
      ...
      if(s0_read > thresh0 && s1_read > thresh1) {
        ...
        Serial.println(s0_read);
      }
      else if(s0_read > thresh0 && s1_read < thresh1) {
        corLeft();
       // Serial.println("Correcting Left");
       Serial.println(s1_read);
      }
...
//  
//      orient(neighbor[nsize-1][0], neighbor[nsize-1][1], visited[(vissize-1)][0], visited[(vissize-1)][1]);
//      Serial.print("initial orientation");
//      Serial.println(orientation);
//      goStraight();
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
