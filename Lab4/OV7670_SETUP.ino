...
void setup() {
  ...
  String a = OV7670_write_register(0x0C , (0 | (1 << 3)));
  //Serial.println(a);
  //Serial.println("stuff");
  OV7670_write_register(0x11 , (0x80 | (1 << 6)));
  OV7670_write_register(0x12 , (0 | (33 << 1)));
  OV7670_write_register(0x14 , (0x4A | (1 << 4)));
  OV7670_write_register(0x1E , (0 | (3 << 4)));
  OV7670_write_register(0x3E , (0x0E | (1 << 3)));
  //Serial.println("stuff");
